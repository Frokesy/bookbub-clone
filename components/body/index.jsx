...
const Body = () => {
  return (
    <div className="lg:mt-[6vh] mt-[3vh] lg:w-[70vw] lg:space-x-[5vw] mx-auto flex lg:flex-row flex-col justify-between">
      <div className="lg:w-[45%] w-[90vw] mx-auto lg:text-start text-center">
        <h2 className="lg:text-[50px] text-[32px] font-extrabold lg:pb-6 pb-2">Amazing deals on bestselling ebooks</h2>
      ...
      <div className="lg:w-[55%] w-[70%] mx-auto mt-[8vh] lg:mt-0">
          <Image src="/assets/side-pane.jpeg" height={700} width={700} alt="side-pane" />
      </div>
    </div>
  )
}
